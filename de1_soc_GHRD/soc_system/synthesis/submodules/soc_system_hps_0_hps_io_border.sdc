...
set_false_path -from [get_ports hps_io_hps_io_gpio_inst_LOANIO58] -to *
set_false_path -from * -to [get_ports hps_io_hps_io_gpio_inst_LOANIO58]
set_false_path -from [get_ports hps_io_hps_io_gpio_inst_LOANIO62] -to *
set_false_path -from * -to [get_ports hps_io_hps_io_gpio_inst_LOANIO62]