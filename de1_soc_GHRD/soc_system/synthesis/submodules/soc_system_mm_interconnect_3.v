...
module soc_system_mm_interconnect_3 (
		...
		input  wire [127:0] hps_0_f2h_sdram1_data_readdata,                                     //                                                             .readdata
	...
	wire  [127:0] render_dma_mm_read_translator_avalon_universal_master_0_readdata;       // render_dma_mm_read_agent:av_readdata -> render_dma_mm_read_translator:uav_readdata
	...
	wire   [15:0] render_dma_mm_read_translator_avalon_universal_master_0_byteenable;     // render_dma_mm_read_translator:uav_byteenable -> render_dma_mm_read_agent:av_byteenable
	...
	wire    [1:0] rsp_mux_src_channel;                                                    // rsp_mux:src_channel -> render_dma_mm_read_agent:rp_channel
	...
	wire  [127:0] render_dma_mm_write_translator_avalon_universal_master_0_readdata;      // render_dma_mm_write_agent:av_readdata -> render_dma_mm_write_translator:uav_readdata
	...
	wire   [15:0] render_dma_mm_write_translator_avalon_universal_master_0_byteenable;    // render_dma_mm_write_translator:uav_byteenable -> render_dma_mm_write_agent:av_byteenable
	...
	wire    [1:0] rsp_mux_001_src_channel;                                                // rsp_mux_001:src_channel -> render_dma_mm_write_agent:rp_channel
	wire          rsp_mux_001_src_startofpacket;                                          // rsp_mux_001:src_startofpacket -> render_dma_mm_write_agent:rp_startofpacket
	wire          rsp_mux_001_src_endofpacket;                                            // rsp_mux_001:src_endofpacket -> render_dma_mm_write_agent:rp_endofpacket
	...
	wire    [1:0] cmd_mux_src_channel;                                                    // cmd_mux:src_channel -> hps_0_f2h_sdram1_data_agent:cp_channel
	...
	wire  [218:0] render_dma_mm_read_agent_cp_data;                                       // render_dma_mm_read_agent:cp_data -> router:sink_data
	...
	wire          render_dma_mm_write_agent_cp_valid;                                     // render_dma_mm_write_agent:cp_valid -> router_001:sink_valid
	wire  [218:0] render_dma_mm_write_agent_cp_data;                                      // render_dma_mm_write_agent:cp_data -> router_001:sink_data
	wire          render_dma_mm_write_agent_cp_ready;                                     // router_001:sink_ready -> render_dma_mm_write_agent:cp_ready
	wire          render_dma_mm_write_agent_cp_startofpacket;                             // render_dma_mm_write_agent:cp_startofpacket -> router_001:sink_startofpacket
	wire          render_dma_mm_write_agent_cp_endofpacket;                               // render_dma_mm_write_agent:cp_endofpacket -> router_001:sink_endofpacket
	wire          router_001_src_valid;                                                   // router_001:src_valid -> cmd_demux_001:sink_valid
	wire  [218:0] router_001_src_data;                                                    // router_001:src_data -> cmd_demux_001:sink_data
	...
	wire          hps_0_f2h_sdram1_data_agent_rp_valid;                                   // hps_0_f2h_sdram1_data_agent:rp_valid -> router_002:sink_valid
	wire  [218:0] hps_0_f2h_sdram1_data_agent_rp_data;                                    // hps_0_f2h_sdram1_data_agent:rp_data -> router_002:sink_data
	wire          hps_0_f2h_sdram1_data_agent_rp_ready;                                   // router_002:sink_ready -> hps_0_f2h_sdram1_data_agent:rp_ready
	wire          hps_0_f2h_sdram1_data_agent_rp_startofpacket;                           // hps_0_f2h_sdram1_data_agent:rp_startofpacket -> router_002:sink_startofpacket
	wire          hps_0_f2h_sdram1_data_agent_rp_endofpacket;                             // hps_0_f2h_sdram1_data_agent:rp_endofpacket -> router_002:sink_endofpacket
	...
	wire  [218:0] cmd_demux_001_src0_data;                                                // cmd_demux_001:src0_data -> cmd_mux:sink1_data
	...
	wire  [218:0] rsp_demux_src1_data;                                                    // rsp_demux:src1_data -> rsp_mux_001:sink0_data
