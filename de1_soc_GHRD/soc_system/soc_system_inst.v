	soc_system u0 (
		...
		.edid_scl                               (<connected-to-edid_scl>),                               //                           edid.scl
		.edid_sda                               (<connected-to-edid_sda>),                               //                               .sda
		...
		.overlay_src_data                       (<connected-to-overlay_src_data>),                       //                    overlay_src.data
		.overlay_src_valid                      (<connected-to-overlay_src_valid>),                      //                               .valid
		.overlay_src_ready                      (<connected-to-overlay_src_ready>),                      //                               .ready
